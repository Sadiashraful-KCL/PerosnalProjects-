...
class ConstraintAnimationsViewController: UIViewController {
    ...
    func animateViewsOnScreen(){
        UIView.animate(withDuration: 1.5, delay: 0.25, usingSpringWithDamping: 0.65, initialSpringVelocity: 0, options: [.curveEaseInOut], animations: {
            self.welcomeCenterX.constant += AnimationManager.screenBounds.width
            self.view.layoutIfNeeded()
        }, completion: nil)
        
        UIView.animate(withDuration: 1.5, delay: 1.0, usingSpringWithDamping: 0.65, initialSpringVelocity: 0, options: [.curveEaseInOut], animations: {
